...
public class BasicCoapClientChannel extends BasicCoapChannel implements CoapClientChannel {
    ...
    @Override
	//Creating a CoAP Request Message
	//reliable=true CON message(Messages always carry a request or response and requires an acknowledgement)
	//reliable=false N0N message(Messagese that do not require a Acknowledgement)
	//channelManager is present in the super class and getNewMessageID() will return the unique Message ID for every message
	...
	//setChannel will require a CoapChannel which is given by Super Class
        msg.setChannel(this);
        return msg;
    }
